...
/*
 Repository Paterrn:Less error Code, Testable, less duplication
...
namespace Books.Api.Services
{
    public class BooksRepository : IBooksRepository, IDisposable
    {
        ...
        public async Task<IEnumerable<BookCover>> GetBookCoversAsync(Guid bookId)
        {
            ...
            //?returnFault=true imagine thread is failed
            var bookCoverUrls = new[]
            {
                $"http://localhost:52644/api/bookcovers/{bookId}-dummycover1",
        ...
        /*
         GC, o recolector de basura, .SuppressFinalize asegura que CLR no llame al finalizador de 
        nuestro repositorio. En otras palabras, le estamos diciendo al recolector
        de basura que este repositorio ya se ha limpiado, como es el caso cuando desechamos el contexto.
         */
        public void Dispose()
        {
            Dispose(true);
        ...
        /*
      * Cuando CLR desecha el repositorio, verificamos si el contexto no es nulo y
      * llamamos a Dispose en ese contexto. Eso asegura que también se elimine.
      */
